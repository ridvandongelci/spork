...
import org.apache.pig.impl.io.InterStorage.InterOutputFormat;
...
public class TFileStorage extends FileInputLoadFunc implements
                StoreFuncInterface, LoadMetadata, LoadSparkFunc, StoreSparkFunc {
	...
	public RDD<Tuple> getRDDfromContext(SparkContext sc, String path,
		...
		RDD<Tuple2<Text, Tuple>> hadoopRDD = sc.newAPIHadoopFile(path,
				TFileInputFormat.class, Text.class, Tuple.class, conf);
	...
	public void putRDD(RDD<Tuple> rdd, String path, JobConf conf) {
        ...
        pairRDDFunctions.saveAsNewAPIHadoopFile(path,Text.class, Tuple.class, TFileOutputFormat.class, conf);
	}
